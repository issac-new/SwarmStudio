...
- **下一实施批（按优先级）**：~~P0 十项~~ → **P0 已落 5/10**（recap 域 v1+来源标头=410；价目表=pricing.ts；squad leader 协议=squad-protocol.ts；任务证据累积轻量版=evidence/ 五 kind 台账=patch 413）→ 余 P0 五项（列级编排//review/任务结果卡+changed-files）→ P1 二十项 → 旧账随迁批（📦9 项）→ 核验批。
