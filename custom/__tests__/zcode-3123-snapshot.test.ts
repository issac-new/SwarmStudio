// overlay/custom/__tests__/zcode-3123-snapshot.test.ts
// ZCode 3.12.3 词条快照完整性守门：快照文件（docs/superpowers/notes/zcode-3123/）
...
/** 快照基线：ZCode.app 3.12.3（asar IntlProvider 内嵌 zh-CN 目录） */
export const SNAPSHOT_BASELINE = { version: '3.12.3', keys: 5446, namespaces: 87, ipcChannels: 138 } as const
