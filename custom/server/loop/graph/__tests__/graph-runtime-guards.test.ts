// overlay/custom/server/loop/graph/__tests__/graph-runtime-guards.test.ts
import { describe, it, expect } from 'vitest'
import { GraphRuntime } from '../graph-runtime'
import { GraphBuilder, fnNode, when } from '../graph-definition'
import { reducers, type GraphEvent, type StateValues } from '../types'
