// overlay/custom/server/loop/graph/__tests__/graph-runtime.test.ts
import { describe, it, expect, vi } from 'vitest'
import { GraphRuntime } from '../graph-runtime'
import { GraphBuilder, fnNode, humanNode, when } from '../graph-definition'
import { InMemoryEventLogStore } from '../event-log-store'
import { reducers } from '../types'
import type { GraphEvent, StateValues } from '../types'
