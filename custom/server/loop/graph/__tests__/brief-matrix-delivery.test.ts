...
import { saveMatrixSession } from '../../../matrix/session-store'
...
vi.mock('../../store/matrix-client', () => ({ getMatrixClient: mocks.getMatrixClient }))

import { createMatrixBriefDelivery } from '../brief-matrix-delivery'
