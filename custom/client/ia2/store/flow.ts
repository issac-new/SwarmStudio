...
/** 管理台五区词表（任务/会话/员工/智能体/团队） */
export type GovSection = 'task' | 'session' | 'people' | 'agent' | 'team'

export const GOV_SECTIONS: readonly GovSection[] = ['task', 'session', 'people', 'agent', 'team']
