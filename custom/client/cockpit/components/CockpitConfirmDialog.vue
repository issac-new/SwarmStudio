...
.cockpit-confirm__box { position: relative; background: var(--bg-card); border: 1px solid var(--border-color); border-radius: 12px; padding: 18px 20px; max-width: 420px; width: 90%; box-shadow: 0 8px 32px rgba(0,0,0,0.3); }
