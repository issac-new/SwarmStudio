...
- **节点检查器**：选中节点查看通道状态（peek 档）与介入动作（attach 档：审批 / 跳过）
...
| 上游项目 | GitHub 仓库 | 用途 |
|---------|-----------|------|
| **hermes-studio** | https://github.com/EKKOLearnAI/hermes-studio | SwarmStudio 桌面应用主体（Vue 前端 + Koa 后端 + Electron 壳），本 overlay 的注入目标（v0.7.18） |
